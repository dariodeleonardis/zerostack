...
| `backup-vps.sh` | Backup automatico giornaliero di PostgreSQL (mantiene gli ultimi 14 giorni) |
...
Per pianificare un backup automatico ogni notte alle 03:00, aggiungi questa riga al crontab del VPS:
